...
Future <String?>dialogjoin(BuildContext context)=>
      showDialog<String>(context: context, builder: (context)=>AlertDialog(
    title: const  Text('Creat Room'),
    content: 
  CustomTextForm(
    ...
    valid: 
    (val) { 
      return validTokenInput(
        val!, 
        _controller.checkToken() 
      ) ;
    }),  
    actions: [ 
  ...
  Future <String?>dialogcreate(BuildContext context)=>
      showDialog<String>(context: context, builder: (context)=>AlertDialog(
  ...
  Widget build(BuildContext context) {
    return Scaffold( 
            floatingActionButton: Createroombutton(onPressed: ()  async{
